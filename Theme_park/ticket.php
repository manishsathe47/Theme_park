...
<body>
	...
	<div class="maincontent">
		<form  action="backend/ticket.php" method="post" autocomplete="off" class="signupformholder" enctype="multipart/form-data">
		<div class="new">
...
<script type="text/javascript" src="js/signup1.js"></script>
  ...
  <a class="lk1" href="ticket1.php"><b>For Coupon Code Facility</b></a><br><br><br>
</body>
</html> 
